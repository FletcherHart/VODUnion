    ...
    <header-layout>
        <div class="h-auto -mt-4">
            <section class="h-screen">
                <iframe title="video" class="h-3/4 w-full" :src="'https://iframe.videodelivery.net/'+ data.videoID +'?autoplay=true'" allow="accelerometer; gyroscope; autoplay; encrypted-media;" allowfullscreen="true"></iframe>
                <div class="mt-3 flex justify-center">
                    <div class="w-11/12">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex">
                                <button v-on:click="like" class="flex focus:outline-none m-1" aria-label="like video">
                                ...
                                <button v-on:click="dislike" class="flex focus:outline-none m-1" aria-label="dislike video">
