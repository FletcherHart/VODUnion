    ...
    <main class="pt-5 bg-gray-400 h-screen fixed sm:top-16 top-24 lg:w-52 md:w-40 sm:w-24 z-20">
        <jet-responsive-nav-link class="w-full" :href="route('home')">
            <div class="grid grid-cols-3 flex items-center">
                <img class="inline col-span-1" width="16px" height="16px" src="/open-iconic/svg/home.svg" alt="home icon">
                <p>Home</p>
            </div>
        ...
        <div v-if="!$page.props.auth.user.loggedIn">
          <jet-responsive-nav-link  :href="route('login')">
            <div class="grid grid-cols-3 flex items-center">
                <img class="inline col-span-1" width="16px" height="16px" src="/open-iconic/svg/account-login.svg" alt="login icon">
                <p>Login</p>
            </div>
          </jet-responsive-nav-link>
          <jet-responsive-nav-link :href="route('register')">
            <div class="grid grid-cols-3 flex items-center">
                <img class="inline col-span-1" width="16px" height="16px" src="/open-iconic/svg/clipboard.svg" alt="register icon">
        ...
        <div v-else>
            <jet-responsive-nav-link :href="route('account')">
                <div class="grid grid-cols-3 flex items-center">
                    <img class="inline col-span-1" width="16px" height="16px" src="/open-iconic/svg/person.svg" alt="account icon">
            ...
            <form @submit.prevent="logout">
                <jet-responsive-nav-link class="object-top" as="button">
                    <div class="grid grid-cols-3 flex items-center">
                        <img class="inline col-span-1" width="16px" height="16px" src="/open-iconic/svg/account-logout.svg" alt="logout icon">
            ...
            <jet-responsive-nav-link href="/channel">
                <div class="grid grid-cols-3 flex items-center">
                    <img class="inline col-span-1" width="16px" height="16px" src="/open-iconic/svg/data-transfer-upload.svg" alt="upload icon">
